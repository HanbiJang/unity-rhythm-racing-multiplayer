...
namespace tinyxml2
{
    ...
    */
    ...
    protected:
        explicit XMLText(XMLDocument* m_doc) : XMLNode(m_doc), _isCData(false) {}
        virtual ~XMLText() {}
    ...
    protected:
        explicit XMLComment(XMLDocument* m_doc);
        virtual ~XMLComment();
    ...
    */
    ...
    protected:
        explicit XMLDeclaration(XMLDocument* m_doc);
    ...
    */
    ...
    protected:
        explicit XMLUnknown(XMLDocument* m_doc);
        virtual ~XMLUnknown();
